...
# Desteklenen Ablation Kombinasyonları:
# ======================================

# 1. Orijinal SAGE (baseline):
#    python SAGE_final.py --dataset CIFAR10 --model resnet8 \
#      --aggregation_method FedAvg --alpha 0.1 --num_labeled 500

# 2. ShapFed only (CIFAR10):
#    python SAGE_final.py --dataset CIFAR10 --model resnet8 \
#      --aggregation_method ShapFed --alpha 0.1 --num_labeled 500

# 3. HAM10000 FedAvg baseline:
#    python SAGE_final.py --dataset HAM10000 --model resnet18 \
#      --aggregation_method FedAvg --alpha 1.0 --num_labeled 100

# 4. HAM10000 + Focal Loss only:
#    python SAGE_final.py --dataset HAM10000 --model resnet18 \
#      --aggregation_method FedAvg --alpha 1.0 --use_focal_loss

# 5. HAM10000 + STFL only:
#    python SAGE_final.py --dataset HAM10000 --model resnet18 \
#      --aggregation_method FedAvg --alpha 1.0 --use_stfl

# 6. HAM10000 Full System:
#    python SAGE_final.py --dataset HAM10000 --model resnet18 \
#      --aggregation_method ShapFed --alpha 1.0 \
#      --use_focal_loss --use_stfl --use_weighted_sampler \
#      --use_medical_augment --use_cosine_lr --use_groupnorm

# Checkpoint ismi otomatik olarak aktif flagleri içerir.
# Örnek: HAM10000_a1.0_ShapFed_resnet18_FL_STFL_WS_MA_CLR_GN_L100_C8_E2_T0.95_LR0.001
# """
...
#         # Orijinal SAGE modeli — CIFAR10 için tasarlanmış
#         from Model.resnet import ResNet as ResNet8
#         model = ResNet8(
...
#         )
#         # HAM10000 ile kullanılıyorsa pooling düzelt
...
#     """
#     Tüm ablation flaglerini içeren benzersiz deney ismi.
#     Örnek: HAM10000_a1.0_ShapFed_resnet18_FL_STFL_WS_MA_CLR_GN_L100_C8_E2_T0.95_LR0.001
#     """
#     flags = []
