...
def main_loop(alpha):
    ...
    drive_ckpt_dir = os.path.join(
        args.checkpoint_dir, f'{args.dataset}_a{alpha}_{args.aggregation_method}'
    )
    # /content'teki hızlı lokal checkpoint dizini
    local_ckpt_dir = f'/content/checkpoints/{args.dataset}_a{alpha}_{args.aggregation_method}'
    os.makedirs(local_ckpt_dir, exist_ok=True)
    os.makedirs(drive_ckpt_dir, exist_ok=True)
