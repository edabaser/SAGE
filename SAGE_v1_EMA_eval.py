...
# [DEĞİŞİKLİK 1]: Sadece 'alpha' yerine, zaten ayrıştırılmış olan tüm 'args' objesini parametre olarak alıyoruz.
def main_loop(args): 
    # args = args_parser()  <-- [DEĞİŞİKLİK 2]: Argümanları tekrar silip okuyan bu satırı sildik.
    # args.alpha = alpha    <-- [DEĞİŞİKLİK 3]: Parametre olarak alpha yerine args aldığımız için bu atama da silindi.
    ...
    if args.alpha == 0:
        ...
        c_lab   = clients_indices(l_lab,   args.num_classes, args.num_clients, args.alpha, seed=0)
        c_unlab = clients_indices(l_unlab, args.num_classes, args.num_clients, args.alpha, seed=0)
...
if __name__ == '__main__':
    ...
    # [DEĞİŞİKLİK 4]: Args bir kez burada, en başta okunuyor.
    args = args_parser() 
    
    # [DEĞİŞİKLİK 5]: Okunan args objesini doğrudan fonksiyona iletiyoruz.
    main_loop(args)
